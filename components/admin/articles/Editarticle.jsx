...
const fetcharticles=async(id)=>{
    try{
        const res=await axios.get(`https://backend-ecommerce-one-bay.vercel.app/api/article/${id}`)
...
const getscategories=async()=>{
 ...
 const handleSave=async(e)=>{
    try{
      e.preventDefault()
      await axios.put(`https://backend-ecommerce-one-bay.vercel.app/api/article/${id}`,article)
      .then(res=>{
        navigate("/articles")
